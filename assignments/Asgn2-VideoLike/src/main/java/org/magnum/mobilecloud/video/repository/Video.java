...
public class Video {
	...
	@ElementCollection
	private List<String> usersLikingThisVideo;
	...
	public List<String> getUsersLikingThisVideo() {
		return usersLikingThisVideo;
	}

	public void setUsersLikingThisVideo(List<String> usersLikingThisVideo) {
		this.usersLikingThisVideo = usersLikingThisVideo;
	}
